...
public class QuizzesFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        q1 = view.findViewById(R.id.editQuizzes1);
        q2 = view.findViewById(R.id.editQuizzes2);
        btnQuizzesSubmit = view.findViewById(R.id.buttonQuiezzesSubmit);
        btnQuizzesSubmit.setOnClickListener(this);
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onQuizzesPressed(Double q1, Double q2);
    }
}
